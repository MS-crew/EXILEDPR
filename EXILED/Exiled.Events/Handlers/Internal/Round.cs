...
namespace Exiled.Events.Handlers.Internal
{
    ...
    internal static class Round
    {
        ...
        {
            if (!ev.Player.IsHost && ev.NewRole == RoleTypeId.Spectator && ev.Reason is not SpawnReason.Destroyed and SpawnReason.Died && Events.Instance.Config.ShouldDropInventory)
