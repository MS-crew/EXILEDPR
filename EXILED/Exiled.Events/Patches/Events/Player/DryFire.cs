    ...
    */
    ...
    internal class DryFirePump
    {
        internal static IEnumerable<CodeInstruction> GetInstructions(CodeInstruction start, Label ret)
        {
            ...
            yield return new(OpCodes.Call, Method(typeof(Player), nameof(Player.OnDryfiringWeapon), new[] { typeof(DryfiringWeaponEventArgs) }));
            ...
            newInstructions.InsertRange(index, new CodeInstruction[]
                {
                    ...
                    new(OpCodes.Stloc_1),
                }.Concat(GetInstructions(newInstructions[0], ret)));
